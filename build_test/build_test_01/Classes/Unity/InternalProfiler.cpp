...
namespace
{
	...
	static void gc_event(MonoProfiler* profiler, MonoGCEvent event, int generation)
	{
		...
		{
			::printf("mono-gc>   stop time: %4.1f mark time: %4.1f reclaim time: %4.1f start time: %4.1f total time: %4.1f \n",
