...
void	UnityRegisterFBO(int api, UnityRenderBuffer color, UnityRenderBuffer depth, unsigned fbo);
void	UnitySetAsDefaultFBO(int api, UnityRenderBuffer color, UnityRenderBuffer depth);
void	UnitySetFBO(int api, UnityRenderBuffer color, UnityRenderBuffer depth);
...
void	UnityReportBackbufferChange(unsigned w, unsigned h);
...
void			UnityUpdateNoBackupFlag(const char* path, int setFlag);
