...
extern "C" void UnityUpdateNoBackupFlag(const char* path, int setFlag)
{
	if(setFlag)
	{
		u_int8_t b = 1;
		::setxattr(path, "com.apple.MobileBackup", &b, 1, 0, 0);
	}
	else
	{
		::removexattr(path, "com.apple.MobileBackup", 0);
	}
}
